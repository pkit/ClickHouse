...
#define LIST_OF_REFRESH_SETTINGS(DECLARE, ALIAS) \
    ...
    DECLARE(String, on_cluster, /* do not change or existing tables will break */ "", "If the materialized view is in an Atomic database, and table is Replicated, use this cluster name to EXCHANGE ON CLUSTER.", 0) \
